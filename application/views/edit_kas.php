...
<html lang="en" dir="ltr">
  ...
  <body>
   ...
   <form class="form-group m-5 " action="<?php echo site_url().'/main/action_edit_kas/'.$kas->Tgl_KAS;?>"  method="post">
       <label for="">Tanggal Kas</label><br>
       <input type="text" name="tanggal_kas" value="<?php echo $kas->Tgl_KAS; ?>"class="form-control"><br>
       <label for="">Kas Masuk</label><br>
       <input type="text" name="kas_masuk" value="<?php echo $kas->Kas_Masuk; ?>"class="form-control"><br>
       <label for="">Kas Akhir</label><br>
       <input type="text" name="kas_akhir" value="<?php echo $kas->Kas_Akhir; ?>"class="form-control"><br>
       <label for="">Kas Keluar</label><br>
       <input type="text" name="kas_keluar" value="<?php echo $kas->Kas_Keluar; ?>"class="form-control"><br>
       <label for="">Keterangan Pengeluaran</label><br>
       <input type="text" name="keterangan_pengeluaran" value="<?php echo $kas->Ket_Pengeluaran; ?>"class="form-control"><br><br>
       <button  name="button_update_kas"   class="btn btn-success">Update</button>
   </form>
      <?php endforeach; ?>
