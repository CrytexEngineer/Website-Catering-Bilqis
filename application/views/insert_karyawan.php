<html lang="en" dir="ltr">
    ...
    <body>
        ...
        <br>
        <div class="form_container_karyawan">


               <form class="form-group m-5 "action="" method="post">
                <label for="">Kode Karyawan</label><br>
                <input type="text" name="kode_karyawan" value="" class="form-control"><br>
                <label for="">Nama Karyawan</label><br>
                <input type="text" name="nama_karyawan" value="" class="form-control"><br>
                <label for="">Jenis Kelamin</label><br>
                <input type="text" name="jenis_kelamin" value="" class="form-control"><br>
                <label for="">Alamat Karyawan</label><br>
                <input type="text" name="alamat_karyawan" value="" class="form-control"><br>
                <label for="">Gaji Karyawan</label><br>
                <input type="text" name="gaji_karyawan" value="" class="form-control"><br>
                <label for="">Nomor KTP</label><br>
                <input type="text" name="nomor_ktp" value="" class="form-control"><br>
                <label for="">No Telepon</label><br>
                <input type="text" name="nomor_telepon" value="" class="form-control"><br>
                <label for="">Tanggal Gajian</label><br>
                <input type="text" name="tanggal_gajian" value="" class="form-control"><br><br>

                <button name="button_insert_karyawan"class="btn btn-success">Insert</button>
