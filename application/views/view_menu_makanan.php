        ...
        <tbody>
            ...
            <?php foreach ($menu_makanan as $menu_makanan): ?>
                <tr>
                    ...
                    <td> <button type="button" name="button_edit_menu_makanan" class="btn btn-success" onclick="location.href='<?php echo site_url().'/main/edit_menu_makanan/'. $menu_makanan->Kd_MenuMakan;?>'">Edit</button>
                        <button type="button" name="button_delete_menu_makanan" class="btn btn-success"><a href="https://localhost/e-pos-catering-bilqis/index.php/main/delete_menu_makanan/<?php echo $menu_makanan->Kd_MenuMakan; ?> ">Delete</a> </button></td>
                    </tr>
            <?php endforeach; ?>
        </tbody>
...
<button name="button_insert_menu_makanan" class="btn btn-success m-5" onclick="location.href='<?php echo site_url().'/main/insert_menu_makanan/';?>'">Insert </button>
