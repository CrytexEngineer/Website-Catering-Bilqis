<html lang="en" dir="ltr">
    <head>
        ...
        <meta charset="utf-8">
        <title>Insert Menu Makanan</title>
    </head>
    <body>
        ...
        <br>
        <div class="form_container_menu_makanan">


            <form class="form-group m-5 "  action="" method="post">
                <label >Kode Menu Makanan</label><br>
                <input type="text" name="kode_menu_makanan" value="" class="form-control"><br>
                <label >Nama Menu</label><br>
                <input type="text" name="nama_menu_makanan" value="" class="form-control"><br>
                <label >Harga</label><br>
                <input type="text" name="harga" value="" class="form-control"><br><br>
                <button  name="button_insert_menu_makanan" class="btn btn-success">Insert</button>
